...
import { Container, Header, ProfilePicture, UserInfo, Name, Email, Role, InfoSection, SectionTitle, InfoGrid, InfoItem, Label, Value, ActionsSection, ActionLink, LogoutButton } from '../../styles/ProfileStyle';
  ...
  return (
    <Container>
      ...
      <ActionsSection>
        ...
        <LogoutButton onClick={handleLogout} disabled={isLoading}>Logout</LogoutButton>
      </ActionsSection>
    </Container>
  );
};
